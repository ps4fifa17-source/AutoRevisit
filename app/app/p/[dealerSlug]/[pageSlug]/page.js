...
export default async function PublicCustomerPage({ params }) {
  ...
  const showWatermark = !plan.removeBranding;
  ...
  const customerMessage = `Hi, I’ve just viewed the ${vehicleTitle} page and I’m interested. Is it still available? ${publicUrl}`;
