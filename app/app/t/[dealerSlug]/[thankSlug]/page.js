...
export default async function PublicThankYouPage({ params }) {
  ...
  const whatsappPhone = (dealer.whatsapp || dealer.phone || "").replace(/[^0-9]/g, "");
  const whatsappText = `Hi, thanks again for the handover page. I had a quick question for ${dealer.name || "the dealership"}.`;
